  ...
  //verify the data is newer than we already have. if not, bail
  var dateElem = card.querySelector('.date');
  if (dateElem.getAttribute('date-dt') >= data.currently.time) {
    return;
  }
  dateElem.setAttribute('date-dt', data.currently.time);
  ...
  //load the intiial data to keep the user engaged
  ...
  /*check for serviceWorker in the browser. if supports, regitser */
